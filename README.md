...
`password123`
|
 Full CRUD, Interactive Grids Editor, Dynamic Skill Additions, Skill Approvals, User RBAC Management 
|
|
**
Sangrakshak
...
`password123`
|
 Read-only Profiles Grid, Launch/Complete Peer Assessments, Task Status Updates 
|
|
**
Utpadak
...
`password123`
|
 Read-only Profiles Grid, View Personal Assessments, Propose Personal Skills 
|
---
